	...
	<div class="main-container">
		<div class="pd-ltr-20">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Approved Schedule</li>
								</ol>
							</nav>
						</div>
				</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">APPROVED SCHEDULE </h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
                                ...
                                $sql = "SELECT id, DepartmentShortName, HODName, folderName, PostingDate, OMRemarks FROM tblschedule WHERE OMRemarks= 1 ORDER BY id DESC";
