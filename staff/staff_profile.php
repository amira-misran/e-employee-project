...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', Phonenumber='$phonenumber', Nationality='$nationality', Race='$race', MaritalStatus='$mstatus'  where emp_id='$session_id'         
		")or die(mysqli_error());
    if ($result) {
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<p class="text-center text-muted font-14"><?php echo $row['Department']; ?></p>
													...
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<select name="nationality" class="custom-select form-control" required="true" autocomplete="off">
																<option value="<?php echo $row['Nationality']; ?>"><?php echo $row['Nationality']; ?></option>
																	<option value="Citizens">Citizens</option>
																	<option value="Non-citizens">Non-citizens</option>
																</select>
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Race</label>
																<input name="race" class="form-control form-control-lg" type="text" placeholder="" required="true" autocomplete="off" value="<?php echo $row['Race']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Marital Status</label>
																<select name="mstatus" class="custom-select form-control" required="true" autocomplete="off">
																<option value="<?php echo $row['MaritalStatus']; ?>"><?php echo $row['Gender']; ?></option>
															...
															<div class="form-group">
																...
																<select name="department" class="custom-select form-control" required="true" autocomplete="off">
																	<?php
																	 ...
																	 ?>
																	<option value="<?php echo $row_staff['Department']; ?>"><?php echo $row_staff['Department']; ?></option>
																		<?php
