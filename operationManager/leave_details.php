...
<?php
	...
	{ 
		...
		if ($status === '2') {
			$sql="update tblleave set OMRemarks=:status,OMDate=:admremarkdate where id=:did";
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblleave, tblemployees set tblleave.OMRemarks='$status',tblleave.OMSign='$signature',tblleave.OMDate='$admremarkdate',tblleave.DaysOutstand='$REMLEAVE', tblemployees.Av_leave='$REMLEAVE' where tblleave.empid = tblemployees.emp_id AND tblleave.id='$did'");
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="form-group row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Reason Description</b></label>
									<input type="text" class="selectpicker form-control" data-style="btn-outline-success" readonly value="<?php echo htmlentities($result->Reason);?>">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
						...
						<div class="form-group row">
							<div class="col-md-6 col-sm-12">
							    <div class="form-group">
									<label style="font-size:16px;"><b>HR's Approval</b></label>
									<?php
									if ($result->HRSign==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
									  <div class="avatar mr-2 flex-shrink-0">
										<img src="<?php echo '../signature/'.($result->HRSign);?>" width="100" height="40" alt="">
									  </div>
									<?php endif ?>
							    </div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Operation Manager's Approval</b></label>
									<?php
									if ($result->OMSign==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
									  <div class="avatar mr-2 flex-shrink-0">
										<img src="<?php echo '../signature/'.($result->OMSign);?>" width="100" height="40" alt="">
									  </div>
									<?php endif ?>
								</div>
							</div>
						...
						<div class="form-group row">
							<div class="col-md-6 col-sm-12">
							    <div class="form-group">
									<label style="font-size:16px;"><b>Date For HR's Action</b></label>
									<?php
									if ($result->HRDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Date For Operation Manager's Action</b></label>
									<?php
									if ($result->OMDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
									  <div class="avatar mr-2 flex-shrink-0">
										<input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo htmlentities($result->OMDate); ?>">
									  </div>
									<?php endif ?>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Leave Status From Operation Manager</b></label>
									<?php $ad_stats=$result->OMRemarks;?>
									<?php
									if ($ad_stats==1): ?>
									  <input type="text" style="color: green;" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "Approved"; ?>">
									<?php
