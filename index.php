		...
		while ($row = mysqli_fetch_assoc($query)) {
		    ...
		    elseif ($row['role'] == 'Staff') {
                ...
                $result = mysqli_query($conn, "UPDATE tblemployees SET status='Online' WHERE emp_id='$emp_id'");
			 	...
			 	echo "<script type='text/javascript'> document.location = 'operationManager/index.php'; </script>";
		    }
	...
	<div class="login-header box-shadow" >
		<div class="container-fluid d-flex justify-content-between align-items-center"  >
			<div class="brand-logo" >
				<a href="login.html">
					<img src="vendors/images/deskapp-logo-svg 1.png" alt="">
				</a>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="vendors/images/login-page-img 1.png" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-dark">Welcome To NSK Meru<br>e employee</h2>
						</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									   <input class="btn btn-lg btn-block" style="background-color: #D35353; color: #fff;" name="signin" id="signin" type="submit" value="Sign In">
									</div>
								</div>
							</div>
						</form>
